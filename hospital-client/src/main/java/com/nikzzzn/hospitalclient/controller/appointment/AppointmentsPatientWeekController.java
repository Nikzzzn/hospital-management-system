...
public class AppointmentsPatientWeekController extends MenuController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            List<Appointment> list = Connector.getAppointmentsForWeekByPatient(patient).orElse(new ArrayList<>());
