...
public class AppointmentsPatientController extends MenuController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            List<Appointment> list = Connector.getAppointmentsByPatient(patient).orElse(new ArrayList<>());
