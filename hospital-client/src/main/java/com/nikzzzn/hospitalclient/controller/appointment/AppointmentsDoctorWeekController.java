...
public class AppointmentsDoctorWeekController extends MenuController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            List<Appointment> list = Connector.getAppointmentsForWeekByDoctor(doctor).orElse(new ArrayList<>());
